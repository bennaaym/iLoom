...
export const StudentForm: React.FC<StudentFormProps> = ({ onSuccess }) => {
    ...
    return (
        <Box>
            <Stack spacing={2}>
                <TextField label="Student Name" name="name" value={formData.name} onChange={handleInputChange} fullWidth />
                <TextField label="Student Email" name="email" value={formData.email} onChange={handleInputChange} fullWidth />
